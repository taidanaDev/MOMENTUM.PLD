...
# Function to get user task and adding the task 
...
def delete_task():  
    ...
    logging.info('User deleted task')
    return redirect(url_for('views.home'))
    
# Function to Update task if done or not
...
def update_task_status():
    ...
    logging.info('User Updated task')
